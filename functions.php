...
function getSlug($string) {
	...
	$allowANSIOnly = true;
	$pattern = array (
			"a" => "Ã¡|Ã |áº¡|áº£|Ã£|Ã�|Ã€|áº |áº¢|Ãƒ|Äƒ|áº¯|áº±|áº·|áº³|áºµ|Ä‚|áº®|áº°|áº¶|áº²|áº´|Ã¢|áº¥|áº§|áº­|áº©|áº«|Ã‚|áº¤|áº¦|áº¬|áº¨|áºª",
			"o" => "Ã³|Ã²|á»�|á»�|Ãµ|Ã“|Ã’|á»Œ|á»Ž|Ã•|Ã´|á»‘|á»“|á»™|á»•|á»—|Ã”|á»�|á»’|á»˜|á»”|á»–|Æ¡|á»›|á»�|á»£|á»Ÿ|á»¡|Æ |á»š|á»œ|á»¢|á»ž|á» ",
			"e" => "Ã©|Ã¨|áº¹|áº»|áº½|Ã‰|Ãˆ|áº¸|áºº|áº¼|Ãª|áº¿|á»�|á»‡|á»ƒ|á»…|ÃŠ|áº¾|á»€|á»†|á»‚|á»„",
			"u" => "Ãº|Ã¹|á»¥|á»§|Å©|Ãš|Ã™|á»¤|á»¦|Å¨|Æ°|á»©|á»«|á»±|á»­|á»¯|Æ¯|á»¨|á»ª|á»°|á»¬|á»®",
			"i" => "Ã­|Ã¬|á»‹|á»‰|Ä©|Ã�|ÃŒ|á»Š|á»ˆ|Ä¨",
			"y" => "Ã½|á»³|á»µ|á»·|á»¹|Ã�|á»²|á»´|á»¶|á»¸",
			"d" => "Ä‘|Ä�",
			"c" => "Ã§" 
	);
