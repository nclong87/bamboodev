...
<div style="float: left; width: 100%; margin-top: 5px;">
	<div id="center">
		...
		$categoryOfCategoryImage = get_category_by_slug('category-image');
		$categoryOfCategoryImageId = $categoryOfCategoryImage->term_id;
		...
		$posts = query_posts(array('post_type' => 'product', 'orderby' => 'name', 'order' => 'ASC','category__and'=>array($categoryOfCategoryImageId,$category->term_id)));
