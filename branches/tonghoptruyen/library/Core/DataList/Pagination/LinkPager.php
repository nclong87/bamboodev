...
{
	const CSS_FIRST_PAGE='pager_first';
	const CSS_LAST_PAGE='pager_last';
	const CSS_PREVIOUS_PAGE='pager_previous';
	const CSS_NEXT_PAGE='pager_next';
	const CSS_INTERNAL_PAGE='pager_page';
	...
	protected function createPageButton($label,$page,$class,$hidden,$selected)
	{
		...
		$link = Core_DataList_Html::link($label,  $selected?'javascript:void(0);':Core_Url::makeUrl(array('page'=>$page)) , array('class'=>$class, 'page'=>$page));
		return Core_DataList_Html::tag('li', $liOptions, $link);
	}
