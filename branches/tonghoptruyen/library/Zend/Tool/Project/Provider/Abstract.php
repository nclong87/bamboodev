...
abstract class Zend_Tool_Project_Provider_Abstract extends Zend_Tool_Framework_Provider_Abstract implements Zend_Tool_Framework_Provider_Initializable {
	...
	public function initialize() {
		...
		if (! self::$_isInitialized) {
			...
			$contextRegistry->addContextsFromDirectory ( dirname ( dirname ( __FILE__ ) ) . '/Context/Zf/', 'Zend_Tool_Project_Context_Zf_' );
			$contextRegistry->addContextsFromDirectory ( dirname ( dirname ( __FILE__ ) ) . '/Context/Filesystem/', 'Zend_Tool_Project_Context_Filesystem_' );
	 ...
	 * the client has been called from..
