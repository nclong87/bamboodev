...
class Zend_Gdata_MediaMimeStream {
	 ...
	 *        	The path to the file that constitutes the binary
	 *        	part of the message.
	...
	public function __construct($xmlString = null, $filePath = null, $fileContentType = null) {
		if (! file_exists ( $filePath ) || ! is_readable ( $filePath )) {
			...
			throw new Zend_Gdata_App_IOException ( 'File to be uploaded at ' . $filePath . ' does not exist or is not readable.' );
		}
