 ...
 * @version    $Id: VideoEntry.php 23775 2011-03-01 17:25:24Z ralph $
 */
...
class Zend_Gdata_YouTube_VideoEntry extends Zend_Gdata_YouTube_MediaEntry {
	 ...
	 *
	 * @return Zend_Gdata_YouTube_Extension_NoEmbed null or not the video can be embedded
	 */
	...
	public function setRacy($racy = null) {
		if ($this->getMajorProtocolVersion () == 2) {
			...
			throw new Zend_Gdata_App_VersionException ( 'Calling getRacy() on a YouTube VideoEntry is deprecated ' . 'as of version 2 of the API.' );
		}
	 ...
	 *
	 * @throws Zend_Gdata_App_VersionException
	 * @return Zend_Gdata_YouTube_Extension_Racy null racy flag object
	 */
	...
	public function getVideoId() {
		if ($this->getMajorProtocolVersion () == 2) {
			...
			if ($position === false) {
				...
				throw new Zend_Gdata_App_Exception ( 'Slash not found in atom:id of ' . $fullId );
			} else {
	 ...
	 * Gets the date that the video was recorded.
	 *
	 * @return string null date that the video was recorded
	 */
	 ...
	 *
	 * @return string null title of the video
	 */
	 ...
	 *
	 * @return string null description of the video
	 */
	 ...
	 *
	 * @return string null URL of the YouTube video watch page
	 */
	public function getVideoWatchPageUrl() {
		$this->ensureMediaGroupIsNotNull ();
		if ($this->getMediaGroup ()->getPlayer () != null && array_key_exists ( 0, $this->getMediaGroup ()->getPlayer () )) {
	 ...
	 *
	 * @return string null URL of the flash player SWF
	 */
	 ...
	 *
	 * @return string null duration of the video, in seconds.
	 */
	 ...
	 *
	 * @return string null number of views for this video
	 */
	 ...
	 *
	 * @return array null location specified for this video
	 */
	public function getVideoGeoLocation() {
		if ($this->getWhere () != null && $this->getWhere ()->getPoint () != null && ($position = $this->getWhere ()->getPoint ()->getPos ()) != null) {
	 ...
	 *
	 * @return array null rating information for this video
	 */
	 ...
	 *
	 * @return string null category of this video
	 */
	...
	public function setVideoCategory($category) {
		$this->ensureMediaGroupIsNotNull ();
		$this->getMediaGroup ()->setCategory ( array (
				new Zend_Gdata_Media_Extension_MediaCategory ( $category, self::YOUTUBE_CATEGORY_SCHEMA ) 
		) );
		return $this;
	}
	 ...
	 *
	 * @return array null developer tags for this video or null if none were set.
	 */
	 ...
	 *
	 * @return Zend_Gdata_YouTube_Extension_State null publishing state of this video
	 */
	public function getVideoState() {
		$control = $this->getControl ();
		if ($control != null && $control->getDraft () != null && $control->getDraft ()->getText () == 'yes') {
	...
	public function setVideoRating($ratingValue) {
		if ($ratingValue < 1 || $ratingValue > 5) {
			...
			throw new Zend_Gdata_App_InvalidArgumentException ( 'Rating for video entry must be between 1 and 5 inclusive.' );
		}
	 ...
	 *
	 * @return string null URL if found, or null if not found.
	 */
