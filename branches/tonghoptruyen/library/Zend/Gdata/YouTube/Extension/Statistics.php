 ...
 * @version    $Id: Statistics.php 23775 2011-03-01 17:25:24Z ralph $
 */
...
class Zend_Gdata_YouTube_Extension_Statistics extends Zend_Gdata_Extension {
	 ...
	 * that a user has watched on YouTube.
	 * The videoWatchCount attribute
	 ...
	 * who have added a video to their list of favorite videos.
	 * The
	 ...
	 * 
	 * @param string $viewCount(optional)
	 *        	The viewCount value
	 * @param string $videoWatchCount(optional)
	 *        	The videoWatchCount value
	 * @param string $subscriberCount(optional)
	 *        	The subscriberCount value
	 * @param string $lastWebAccess(optional)
	 *        	The lastWebAccess value
	 * @param string $favoriteCount(optional)
	 *        	The favoriteCount value
	 */
	 ...
	 * instance members.
	 * If no mapping is defined, the name and valueare
	 * stored in an array.
	...
	public function __toString() {
		return 'View Count=' . $this->_viewCount . ' VideoWatchCount=' . $this->_videoWatchCount . ' SubscriberCount=' . $this->_subscriberCount . ' LastWebAccess=' . $this->_lastWebAccess . ' FavoriteCount=' . $this->_favoriteCount;
	}
}
