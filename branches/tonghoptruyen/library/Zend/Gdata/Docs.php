...
class Zend_Gdata_Docs extends Zend_Gdata {
	 ...
	 * 
	 * @param string $docId
	 *        	The URL key for the document. Examples:
	 *        	dcmg89gw_62hfjj8m, pKq0CzjiF3YmGd0AIlHKqeg
	 * @param string $docType
	 *        	The type of the document as used in the Google
	 *        	Document List URLs. Examples: document, spreadsheet, presentation
	 * @return Zend_Gdata_Docs_DocumentListEntry
	 */
	public function getDoc($docId, $docType) {
		$location = 'https://docs.google.com/feeds/documents/private/full/' . $docType . '%3A' . $docId;
	 ...
	 *
	 * @param string $id
	 *        	The URL id for the document. Example:
	 *        	dcmg89gw_62hfjj8m
	 */
	 ...
	 *        	The full or relative path of the file to
	 *        	be uploaded.
	 * @param string $title
	 ...
	 * @param string|null $folderResourceId
