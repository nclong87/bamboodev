...
class Zend_Gdata_Gapps_GroupQuery extends Zend_Gdata_Gapps_Query {
	 ...
	 *
	 * @param string $value
	 *        	The group id to filter search results by, or
	 *        	null if disabled.
	 */
	 ...
	 *
	 * @param string $value
	 *        	The member email address to filter search
	 ...
	 *
	 * @param string $value
	 *        	The first group id to be returned, or null to
	 *        	disable.
	 */
