 ...
 * @version    $Id: FeedEntryParent.php 23775 2011-03-01 17:25:24Z ralph $
 */
...
abstract class Zend_Gdata_App_FeedEntryParent extends Zend_Gdata_App_Base {
	 ...
	 * perform network requests, such as when calling save() and delete().
	 *
	 * @return Zend_Gdata_App null current service instance, or null if
	 *         not set.
	 */
	 ...
	 *
	 * @see _majorProtocolVersion
	 * @return (int NULL) major protocol version in use.
	 */
	...
	public function setMinorProtocolVersion($value) {
		if (! ($value >= 0)) {
			require_once ('Zend/Gdata/App/InvalidArgumentException.php');
			throw new Zend_Gdata_App_InvalidArgumentException ( 'Minor protocol version must be >= 0 or null' );
		}
