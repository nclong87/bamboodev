...
class Zend_Gdata_App {
	 ...
	 * @return string Zend_Gdata_App_Feed string only if the object
	 ...
	 * @param string $className
	 *        	The class which is used as the return type
	 * @return string Zend_Gdata_App_Entry string only if the object
	 *         mapping has been disabled explicitly
	 *         by passing false to the
	 *         useObjectMapping() function.
	 */
	 ...
	 *
	 * @see _minorProtocolVersion
	 * @return (int NULL) major protocol version in use, or NULL if no
	 ...
	 *
	 * @param string $method
	 *        	The HTTP method for the request - 'GET', 'POST',
	 *        	'PUT', 'DELETE'
	 * @param string $url
	 ...
	 *        	request
	 * @param mixed $data
	 *        	The Zend_Gdata_App_Entry or XML for the
	 *        	body of the request
	 * @param string $contentTypeOverride
	 *        	The override value for the
	 ...
	 *        	of the request body
	 * @param int $remainingRedirects
	 *        	Number of redirects to follow if request
	 *        	s results in one
	 ...
	 * @param string $className
	 *        	The class which is used as the return type
	 * @param integer $majorProcolVersion
	 *        	(optional) The major protocol version
	 *        	of the data model object that is to be created.
	 * @param integer $minorProcolVersion
	 *        	(optional) The minor protocol version
	 *        	of the data model object that is to be created.
	 * @throws Zend_Gdata_App_Exception
	 ...
	 * @param
	 *        	string|null The URI to send requests to, or null if $data
	 *        	contains the URI.
	 * @param
	 *        	string|null The name of the class that should be deserialized
	 ...
	 * naming conventions.
	 * For instance, to construct a new
	 ...
	 * property.
	 * If Etags are not supported by the server or cannot be
	 * extracted from the data, then null will be returned.
	 *
	 * @param boolean $allowWeak
	 *        	If false, then if a weak Etag is detected,
