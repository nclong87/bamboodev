...
class Zend_Gdata_Feed extends Zend_Gdata_App_Feed {
	...
	public function getDOM($doc = null, $majorVersion = 1, $minorVersion = null) {
		...
		if ($majorVersion >= 2) {
			if ($this->_etag != null) {
				$element->setAttributeNS ( $this->lookupNamespace ( 'gd' ), 'gd:etag', $this->_etag );
			}
		}
	 ...
	 *
	 * @return Zend_Gdata_Extension_OpenSearchTotalResults null value of
	 ...
	 *
	 * @return Zend_Gdata_Extension_OpenSearchStartIndex null value of the
	 ...
	 *
	 * @return Zend_Gdata_Extension_OpenSearchItemsPerPage null value of
