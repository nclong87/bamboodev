...
class Zend_Measure_Length extends Zend_Measure_Abstract {
	...
	protected $_units = array (
			...
			'CITY_BLOCK_US_EAST' => array (
					'80.4672',
					'block' 
			),
			'CITY_BLOCK_US_WEST' => array (
					'100.584',
					'block' 
			),
			'CITY_BLOCK_US_SOUTH' => array (
					'160.9344',
					'block' 
			),
			'CLICK' => array (
			...
			'CUADRA_ARGENTINA' => array (
					'130',
					'cuadra' 
			),
			'Length:CUBIT_EGYPT' => array (
					'0.45',
					'cubit' 
			),
			'CUBIT_ROYAL' => array (
			...
			'FOOTBALL_FIELD_CANADA' => array (
					'100.584',
					'football field' 
			),
			'FOOTBALL_FIELD_US' => array (
					'91.44',
					'football field' 
			),
			'FOOTBALL_FIELD' => array (
					'109.728',
					'football field' 
			),
			'FURLONG' => array (
			...
			'MILE_NAUTIC_UK' => array (
					'1853.184',
					'mi' 
			),
			'MILE_NAUTIC_US' => array (
					'1852',
					'mi' 
			),
			'MILE_ANCIENT' => array (
