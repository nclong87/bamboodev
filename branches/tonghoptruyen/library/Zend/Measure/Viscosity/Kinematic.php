 ...
 * @version   $Id: Kinematic.php 23775 2011-03-01 17:25:24Z ralph $
 */
...
class Zend_Measure_Viscosity_Kinematic extends Zend_Measure_Abstract {
	...
	protected $_units = array (
			...
			'LITER_PER_CENTIMETER_DAY' => array (
					array (
							'' => '1',
							'/' => '864000' 
					),
			...
			'LITER_PER_CENTIMETER_HOUR' => array (
					array (
							'' => '1',
							'/' => '36000' 
					),
			...
			'LITER_PER_CENTIMETER_MINUTE' => array (
					array (
							'' => '1',
							'/' => '600' 
					),
			...
			'LITER_PER_CENTIMETER_SECOND' => array (
					'0.1',
					'l/cm s' 
			),
			'POISE_CUBIC_CENTIMETER_PER_GRAM' => array (
					'0.0001',
					'P cm³/g' 
			),
			'SQUARE_CENTIMETER_PER_DAY' => array (
					array (
							'' => '1',
							'/' => '864000000' 
					),
			...
			'SQUARE_CENTIMETER_PER_HOUR' => array (
					array (
							'' => '1',
							'/' => '36000000' 
					),
			...
			'SQUARE_CENTIMETER_PER_MINUTE' => array (
					array (
							'' => '1',
							'/' => '600000' 
					),
			...
			'SQUARE_CENTIMETER_PER_SECOND' => array (
					'0.0001',
					'cm²/s' 
			),
			'SQUARE_FOOT_PER_DAY' => array (
					'0.0000010752667',
					'ft²/day' 
			),
			'SQUARE_FOOT_PER_HOUR' => array (
					'0.0000258064',
					'ft²/h' 
			),
			'SQUARE_FOOT_PER_MINUTE' => array (
					'0.001548384048',
					'ft²/m' 
			),
			'SQUARE_FOOT_PER_SECOND' => array (
					'0.09290304',
					'ft²/s' 
			),
			'SQUARE_INCH_PER_DAY' => array (
					'7.4671296e-9',
					'in²/day' 
			),
			'SQUARE_INCH_PER_HOUR' => array (
					'0.00000017921111',
					'in²/h' 
			),
			'SQUARE_INCH_PER_MINUTE' => array (
					'0.000010752667',
					'in²/m' 
			),
			'SQUARE_INCH_PER_SECOND' => array (
					'0.00064516',
					'in²/s' 
			),
			'SQUARE_METER_PER_DAY' => array (
					array (
							'' => '1',
							'/' => '86400' 
					),
			...
			'SQUARE_METER_PER_SECOND' => array (
					'1',
					'm²/s' 
			),
			'SQUARE_MILLIMETER_PER_DAY' => array (
					array (
							'' => '1',
							'/' => '86400000000' 
					),
			...
			'SQUARE_MILLIMETER_PER_HOUR' => array (
					array (
							'' => '1',
							'/' => '3600000000' 
					),
			...
			'SQUARE_MILLIMETER_PER_MINUTE' => array (
					array (
							'' => '1',
							'/' => '60000000' 
					),
			...
			'SQUARE_MILLIMETER_PER_SECOND' => array (
					'0.000001',
					'mm²/s' 
			),
			'STOKES' => array (
