 ...
 * @version   $Id: Power.php 23775 2011-03-01 17:25:24Z ralph $
 */
...
class Zend_Measure_Power extends Zend_Measure_Abstract {
	...
	protected $_units = array (
			...
			'BTU_PER_MINUTE' => array (
					'17.5843182',
					'BTU/m' 
			),
			'BTU_PER_SECOND' => array (
					'1055.059092',
					'BTU/s' 
			),
			'CALORIE_PER_HOUR' => array (
					array (
							'' => '11630',
							'*' => '1.0e-7' 
					),
			...
			'DYNE_CENTIMETER_PER_HOUR' => array (
					array (
							'' => '1.0e-7',
							'/' => '3600' 
					),
			...
			'DYNE_CENTIMETER_PER_MINUTE' => array (
					array (
							'' => '1.0e-7',
							'/' => '60' 
					),
			...
			'DYNE_CENTIMETER_PER_SECOND' => array (
					'1.0e-7',
					'dyn cm/s' 
			),
			'ERG_PER_HOUR' => array (
			...
			'FOOT_POUND_FORCE_PER_HOUR' => array (
					array (
							'' => '1.3558179',
							'/' => '3600' 
					),
			...
			'FOOT_POUND_FORCE_PER_MINUTE' => array (
					array (
							'' => '1.3558179',
							'/' => '60' 
					),
			...
			'FOOT_POUND_FORCE_PER_SECOND' => array (
					'1.3558179',
					'ft lb/s' 
			),
			'FOOT_POUNDAL_PER_HOUR' => array (
					array (
							'' => '0.04214011',
							'/' => '3600' 
					),
			...
			'GRAM_FORCE_CENTIMETER_PER_HOUR' => array (
					array (
							'' => '0.0000980665',
							'/' => '3600' 
					),
			...
			'GRAM_FORCE_CENTIMETER_PER_MINUTE' => array (
					array (
							'' => '0.0000980665',
							'/' => '60' 
					),
			...
			'GRAM_FORCE_CENTIMETER_PER_SECOND' => array (
					'0.0000980665',
					'gf cm/s' 
			),
			'HECTOWATT' => array (
			...
			'HORSEPOWER_INTERNATIONAL' => array (
					'745.69987',
					'hp' 
			),
			'HORSEPOWER_ELECTRIC' => array (
					'746',
					'hp' 
			),
			'HORSEPOWER' => array (
			...
			'HORSEPOWER_WATER' => array (
					'746.043',
					'hp' 
			),
			'INCH_OUNCH_FORCE_REVOLUTION_PER_MINUTE' => array (
					'0.00073948398',
					'in ocf/m' 
			),
			'JOULE_PER_HOUR' => array (
					array (
							'' => '1',
							'/' => '3600' 
					),
			...
			'JOULE_PER_SECOND' => array (
					'1',
					'J/s' 
			),
			'KILOCALORIE_PER_HOUR' => array (
					'1.163',
					'kcal/h' 
			),
			'KILOCALORIE_PER_MINUTE' => array (
					'69.78',
					'kcal/m' 
			),
			'KILOCALORIE_PER_SECOND' => array (
					'4186.8',
					'kcal/s' 
			),
			'KILOGRAM_FORCE_METER_PER_HOUR' => array (
					array (
							'' => '9.80665',
							'/' => '3600' 
					),
			...
			'KILOGRAM_FORCE_METER_PER_MINUTE' => array (
					array (
							'' => '9.80665',
							'/' => '60' 
					),
			...
			'KILOGRAM_FORCE_METER_PER_SECOND' => array (
					'9.80665',
					'kfg m/s' 
			),
			'KILOPOND_METER_PER_HOUR' => array (
					array (
							'' => '9.80665',
							'/' => '3600' 
					),
			...
			'KILOPOND_METER_PER_MINUTE' => array (
					array (
							'' => '9.80665',
							'/' => '60' 
					),
			...
			'KILOPOND_METER_PER_SECOND' => array (
					'9.80665',
					'kp/s' 
			),
			'KILOWATT' => array (
			...
			'POUND_SQUARE_FOOT_PER_CUBIC_SECOND' => array (
					'0.04214011',
					'lb ft²/s³' 
			),
			'TERAWATT' => array (
