 ...
 * @version   $Id: Area.php 23775 2011-03-01 17:25:24Z ralph $
 */
...
class Zend_Measure_Area extends Zend_Measure_Abstract {
	...
	protected $_units = array (
			...
			'CABALLERIA_AMERICA' => array (
					'450000',
					'caballeria' 
			),
			'CABALLERIA_CUBA' => array (
					'134200',
					'caballeria' 
			),
			'CARREAU' => array (
			...
			'SQUARE_ANGSTROM' => array (
					'1.0e-20',
					'A²' 
			),
			'SQUARE_ASTRONOMICAL_UNIT' => array (
					'2.2379523e+22',
					'AU²' 
			),
			'SQUARE_ATTOMETER' => array (
					'1.0e-36',
					'am²' 
			),
			'SQUARE_BICRON' => array (
			...
			'SQUARE_CHAIN_ENGINEER' => array (
					'929.03412',
					'ch²' 
			),
			'SQUARE_CITY_BLOCK_US_EAST' => array (
					'4.97027584',
					'sq block' 
			),
			'SQUARE_CITY_BLOCK_US_WEST' => array (
					'17.141056',
					'sq block' 
			),
			'SQUARE_CITY_BLOCK_US_SOUTH' => array (
					'99.88110336',
					'sq block' 
			),
			'SQUARE_CUBIT' => array (
			...
			'SQUARE_LINK_ENGINEER' => array (
					'0.092903412',
					'sq link' 
			),
			'SQUARE_MEGAMETER' => array (
					'1.0e+12',
					'Mm²' 
			),
			'SQUARE_METER' => array (
			...
			'SQUARE_MICROMETER' => array (
					'1.0e-12',
					'µm²' 
			),
			'SQUARE_MICROMICRON' => array (
					'1.0e-24',
					'µµ²' 
			),
			'SQUARE_MICRON' => array (
			...
			'SQUARE_MILE_NAUTIC' => array (
					'3429904',
					'mi²' 
			),
			'SQUARE_MILE_SURVEY' => array (
					'2589998.5',
					'mi²' 
			),
			...
			'SQUARE_MILLIMICRON' => array (
					'1.0e-18',
					'mµ²' 
			),
			'SQUARE_MYRIAMETER' => array (
					'1.0e+8',
					'mym²' 
			),
			'SQUARE_NANOMETER' => array (
					'1.0e-18',
					'nm²' 
			),
			'SQUARE_PARIS_FOOT' => array (
					'0.1055',
					'sq paris foot' 
			),
			'SQUARE_PARSEC' => array (
			...
			'SQUARE_TENTHMETER' => array (
					'1.0e-20',
					'sq tenth-meter' 
			),
			'SQUARE_TERAMETER' => array (
					'1.0e+24',
					'Tm²' 
			),
			'SQUARE_THOU' => array (
			...
			'SQUARE_YARD_SURVEY' => array (
					'0.836130708',
					'yd²' 
			),
			'SQUARE_YOCTOMETER' => array (
					'1.0e-48',
					'ym²' 
			),
			'SQUARE_YOTTAMETER' => array (
					'1.0e+48',
					'Ym²' 
			),
			'STANG' => array (
