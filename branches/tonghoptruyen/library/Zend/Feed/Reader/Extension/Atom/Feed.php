...
class Zend_Feed_Reader_Extension_Atom_Feed extends Zend_Feed_Reader_Extension_FeedAbstract {
	...
	public function getLink() {
		...
		$list = $this->_xpath->query ( $this->getXpathPrefix () . '/atom:link[@rel="alternate"]/@href' . '|' . $this->getXpathPrefix () . '/atom:link[not(@rel)]/@href' );
	...
	public function getHubs() {
		...
		$list = $this->_xpath->query ( $this->getXpathPrefix () . '//atom:link[@rel="hub"]/@href' );
