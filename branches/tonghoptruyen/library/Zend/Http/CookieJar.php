...
class Zend_Http_CookieJar implements Countable, IteratorAggregate {
	 ...
	 * Cookie should be passed either as a Zend_Http_Cookie object
	 ...
	 * @param boolean $matchSessionCookies
	 ...
	 * Shoud be used when exporting the
	 ...
	 * cookies set in an Http_Response object.
