...
class Zend_Http_Client {
	...
	/**
	 * Constructor method.
	 * Will create a new HTTP client. Accepts the target
	...
	public function setHeaders($name, $value = null) {
		...
		if (is_array ( $name )) {
			...
			if ($value === null || $value === false) {
				...
				$this->headers [$normalized_name] = array (
						$name,
						$value 
				);
			}
	 ...
	 *
	 * @param string $key        	
	 * @return string array null value or null if it is not set
	 */
	 ...
	 * and responses.
	 *
	 * @param Zend_Http_CookieJar|boolean $cookiejar
	 ...
	 * If the client has no Cookie Jar, the cookies
	 ...
	 *
	 * @param string|boolean $streamfile
