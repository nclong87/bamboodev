...
class Zend_Service_Amazon_Ec2_Image extends Zend_Service_Amazon_Ec2_Abstract {
	 ...
	 * Images must be registered before
	 ...
	 *        	Unique ID of a machine image, returned by a call
	 ...
	 *        	Specifies the attribute to modify. See the preceding
	 ...
	 *        	Required for launchPermssion Attribute
	 * @param string|array $userGroup
	 *        	User groups to add to or remove from the launchPermission attribute.
	 *        	Currently, the all group is available, which will make it a public AMI.
	 *        	Required for launchPermssion Attribute
	 * @param string $productCode
	 *        	Attaches a product code to the AMI. Currently only one product code
	 ...
	 * @param string $attribute
	 *        	Specifies the attribute to describe. Valid Attributes are
	 ...
	 * @param String $attribute
	 *        	Specifies the attribute to reset. Currently, only launchPermission is supported.
