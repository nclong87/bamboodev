...
class Zend_Service_Amazon_Ec2_CloudWatch extends Zend_Service_Amazon_Ec2_Abstract {
	 ...
	 * The following table lists the statistics that you can request:
	 *
	 ...
	 * @var array
	 */
	protected $_validStatistics = array (
			'Average',
			'Maximum',
			'Minimum',
			'Samples',
	 ...
	 *
	 * @param array $options
	 *        	The options you want to get statistics for:
	 *        	** Required **
	 ...
	 *        	The NextToken parameter is an optional parameter
