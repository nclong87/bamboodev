...
class Zend_Locale_Format {
	 ...
	 * The 'precision' option of a value is used to truncate or stretch extra digits.
	 * -1 means not to touch the extra digits.
	...
	public static function getNumber($input, array $options = array()) {
		...
		if ((strpos ( $input, $symbols ['minus'] ) !== false) || (strpos ( $input, '-' ) !== false)) {
	 ...
	 * month in php's date() will return the translated month name with this function...
	 * use 'en' as locale
	 ...
	 *        	List of month names
	 *        	
	 * @return int false of replaced string (false if nothing replaced)
	 */
	 ...
	 * according to the order described in $format.
	 * For a format of 'H:m:s', and
	 ...
	 * extracted from $datetime according to the order described in $format.
	 * For a format of 'd.M.y H:m:s',
