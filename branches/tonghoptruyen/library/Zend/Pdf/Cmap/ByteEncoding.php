...
class Zend_Pdf_Cmap_ByteEncoding extends Zend_Pdf_Cmap {
	...
	/**
	 * Glyph index array.
	 * Stores the actual glyph numbers. The array keys are
	...
	public function __construct($cmapData) {
		...
		/*
		 * The mapping between the Mac Roman and Unicode characters is static. For simplicity, just put all 256 glyph indices into one array keyed off the corresponding Unicode character.
		 */
		$i = 6;
