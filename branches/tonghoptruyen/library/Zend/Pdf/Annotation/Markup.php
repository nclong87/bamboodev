...
class Zend_Pdf_Annotation_Markup extends Zend_Pdf_Annotation {
	...
	public function __construct(Zend_Pdf_Element $annotationDictionary) {
		...
		if ($annotationDictionary->Subtype === null || $annotationDictionary->Subtype->getType () != Zend_Pdf_Element::TYPE_NAME || ! in_array ( $annotationDictionary->Subtype->value, array (
