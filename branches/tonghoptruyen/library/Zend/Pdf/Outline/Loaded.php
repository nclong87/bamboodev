 ...
 * @version    $Id: Loaded.php 23775 2011-03-01 17:25:24Z ralph $
 */
...
class Zend_Pdf_Outline_Loaded extends Zend_Pdf_Outline {
	...
	public function setColor(Zend_Pdf_Color_Rgb $color) {
		...
		if ($color === null) {
			...
			$colorComponentElements = array (
					new Zend_Pdf_Element_Numeric ( $components [0] ),
	 ...
	 * @param SplObjectStorage $processedOutlines
	 *        	List of already processed Outline dictionaries,
