 ...
 * @version    $Id: CidFont.php 23775 2011-03-01 17:25:24Z ralph $
 */
...
abstract class Zend_Pdf_Resource_Font_CidFont extends Zend_Pdf_Resource_Font {
	...
	public function __construct(Zend_Pdf_FileParser_Font_OpenType $fontParser) {
		...
		/*
		 * Create the Zend_Pdf_Element_Array object and add it to the font's object factory and resource dictionary.
		 */
	...
	public function glyphNumbersForCharacters($characterCodes) {
		/**
		 * CIDFont object is not actually a font.
	...
	public function getCoveredPercentage($string, $charEncoding = '') {
		/*
		 * Convert the string to UTF-16BE encoding so we can match the string's character codes to those found in the cmap.
		 */
