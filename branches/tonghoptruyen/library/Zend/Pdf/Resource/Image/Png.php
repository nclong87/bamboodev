...
class Zend_Pdf_Resource_Image_Png extends Zend_Pdf_Resource_Image {
	...
	public function __construct($imageFileName) {
		...
		/*
		 * The following loop processes PNG chunks. 4 Byte Longs are packed first give the chunk length followed by the chunk signature, a four byte code. IDAT and IEND are manditory in any PNG.
		 */
