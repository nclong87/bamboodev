...
class Zend_Db_Profiler {
	...
	/**
	 * Class constructor.
	 * The profiler is disabled by default unless it is
	...
	/**
	 * Ends a query.
	 * Pass it the handle that was returned by queryStart().
	 ...
	 * Pass it the same handle that was returned
	 ...
	 * Only queries that have ended will
	 ...
	 * ended or not.
	 * If the query has not ended, its end time will be null. If no queries have
