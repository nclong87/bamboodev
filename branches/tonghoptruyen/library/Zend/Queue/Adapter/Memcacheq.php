 ...
 * @version    $Id: Memcacheq.php 23775 2011-03-01 17:25:24Z ralph $
 */
...
class Zend_Queue_Adapter_Memcacheq extends Zend_Queue_Adapter_AdapterAbstract {
	...
	public function delete($name) {
		$response = $this->_sendCommand ( 'delete ' . $name, array (
				'DELETED',
				'NOT_FOUND' 
		), true );
	...
	public function getQueues() {
		...
		$response = $this->_sendCommand ( 'stats queue', array (
				'END' 
		) );
	 ...
	 * @param array $terminator
	 *        	- strings to indicate end of memcacheQ response
	 * @param boolean $include_term
