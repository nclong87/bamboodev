...
class Zend_Search_Lucene_Search_Query_MultiTerm extends Zend_Search_Lucene_Search_Query {
	...
	public function execute(Zend_Search_Lucene_Interface $reader, $docsFilter = null) {
        ...
        $this// Initialize weight if it's not done yet
		null->_initWeight ( $reader );
	}
	...
	public function __toString() {
        ...
        $query// It's used only for query visualisation, so we don't care about characters escaping
		null = '';
