 ...
 * @version    $Id: Similarity.php 23775 2011-03-01 17:25:24Z ralph $
 */
...
abstract class Zend_Search_Lucene_Search_Similarity {
	 ...
	 * This value is then multipled into the
	...
	private static function _floatToByte($f) {
		...
		if ($highIndex != 255 && $f - self::$_normTable [$highIndex] > self::$_normTable [$highIndex + 1] - $f) {
			return $highIndex + 1;
		} else {
			return $highIndex;
		}
	 ...
	 * document.
	 * This value is multiplied by the idf(Term, Searcher)
