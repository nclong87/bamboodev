...
class Zend_Controller_Router_Route_Hostname extends Zend_Controller_Router_Route_Abstract {
	 ...
	 * Array index holds a position in host.
	 * 
	 * @var array
	 */
	...
	/**
	 * Holds Route patterns for all host parts.
	 * In case of a variable it stores it's regex
	 ...
	 * to a corresponding atomic parts.
	 * These parts are assigned
	 ...
	 * @return array false array of assigned values or a false on a mismatch
	 */
