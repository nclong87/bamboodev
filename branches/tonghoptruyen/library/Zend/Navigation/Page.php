...
abstract class Zend_Navigation_Page extends Zend_Navigation_Container {
		...
		if (isset ( $type )) {
			if (is_string ( $type ) && ! empty ( $type )) {
				...
				if (! $page instanceof Zend_Navigation_Page) {
					require_once 'Zend/Navigation/Exception.php';
					throw new Zend_Navigation_Exception ( sprintf ( 'Invalid argument: Detected type "%s", which ' . 'is not an instance of Zend_Navigation_Page', $type ) );
				}
				return $page;
			}
		}
	...
	public function setLabel($label) {
		if (null !== $label && ! is_string ( $label )) {
			require_once 'Zend/Navigation/Exception.php';
			throw new Zend_Navigation_Exception ( 'Invalid argument: $label must be a string or null' );
		}
	...
	public function setFragment($fragment) {
		if (null !== $fragment && ! is_string ( $fragment )) {
			require_once 'Zend/Navigation/Exception.php';
			throw new Zend_Navigation_Exception ( 'Invalid argument: $fragment must be a string or null' );
		}
	...
	public function setId($id = null) {
		if (null !== $id && ! is_string ( $id ) && ! is_numeric ( $id )) {
			require_once 'Zend/Navigation/Exception.php';
			throw new Zend_Navigation_Exception ( 'Invalid argument: $id must be a string, number or null' );
		}
	...
	public function setClass($class = null) {
		if (null !== $class && ! is_string ( $class )) {
			require_once 'Zend/Navigation/Exception.php';
			throw new Zend_Navigation_Exception ( 'Invalid argument: $class must be a string or null' );
		}
	...
	public function setTitle($title = null) {
		if (null !== $title && ! is_string ( $title )) {
			require_once 'Zend/Navigation/Exception.php';
			throw new Zend_Navigation_Exception ( 'Invalid argument: $title must be a non-empty string' );
		}
	...
	public function setTarget($target = null) {
		if (null !== $target && ! is_string ( $target )) {
			require_once 'Zend/Navigation/Exception.php';
			throw new Zend_Navigation_Exception ( 'Invalid argument: $target must be a string or null' );
		}
	 ...
	 * Returns page target
	 *
	 * @return string null target or null
	 */
	...
	public function setAccesskey($character = null) {
		if (null !== $character && (! is_string ( $character ) || 1 != strlen ( $character ))) {
			require_once 'Zend/Navigation/Exception.php';
			throw new Zend_Navigation_Exception ( 'Invalid argument: $character must be a single character or null' );
		}
	 ...
	 *
	 * @return string null access key or null
	 */
	 ...
	 *
	 * @param array|Zend_Config $relations
	...
	public function setRel($relations = null) {
		...
		if (null !== $relations) {
			...
			if (! is_array ( $relations )) {
				require_once 'Zend/Navigation/Exception.php';
				throw new Zend_Navigation_Exception ( 'Invalid argument: $relations must be an ' . 'array or an instance of Zend_Config' );
			}
	...
	public function setOrder($order = null) {
		...
		if (null !== $order && ! is_int ( $order )) {
			require_once 'Zend/Navigation/Exception.php';
			throw new Zend_Navigation_Exception ( 'Invalid argument: $order must be an integer or null, ' . 'or a string that casts to an integer' );
		}
	...
	public function setResource($resource = null) {
		if (null === $resource || is_string ( $resource ) || $resource instanceof Zend_Acl_Resource_Interface) {
			...
			require_once 'Zend/Navigation/Exception.php';
			throw new Zend_Navigation_Exception ( 'Invalid argument: $resource must be null, a string, ' . ' or an instance of Zend_Acl_Resource_Interface' );
		}
	 ...
	 *
	 * @return string Zend_Acl_Resource_Interface null or null
	 */
	...
	public function isVisible($recursive = false) {
		if ($recursive && isset ( $this->_parent ) && $this->_parent instanceof Zend_Navigation_Page) {
	 ...
	 *
	 * @param Zend_Navigation_Container $parent
	 ...
	 *
	 * @return Zend_Navigation_Container null container or null
	 */
	...
	public function set($property, $value) {
		if (! is_string ( $property ) || empty ( $property )) {
			require_once 'Zend/Navigation/Exception.php';
			throw new Zend_Navigation_Exception ( 'Invalid argument: $property must be a non-empty string' );
		}
	...
	public function __unset($name) {
		...
		if (method_exists ( $this, $method )) {
			require_once 'Zend/Navigation/Exception.php';
			throw new Zend_Navigation_Exception ( sprintf ( 'Unsetting native property "%s" is not allowed', $name ) );
		}
