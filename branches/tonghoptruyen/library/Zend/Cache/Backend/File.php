...
class Zend_Cache_Backend_File extends Zend_Cache_Backend implements Zend_Cache_Backend_ExtendedInterface {
	 ...
	 *
	 * @param string $value        	
	 * @param boolean $trailingSeparator
	 ...
	 * @param string $id
	 *        	Cache id
	 * @return array false array of metadatas
	 */
	 ...
	 * @param boolean $doNotTestCacheValidity
	 *        	If set to true, the cache validity won't be tested
	 * @return boolean mixed (a cache is not available) or "last modified" timestamp (int) of the available cache record
	 */
