...
class Zend_Barcode {
	 ...
	 * @param boolean $automaticRenderError
	...
	public static function factory($barcode, $renderer = 'image', $barcodeConfig = array(), $rendererConfig = array(), $automaticRenderError = true) {
		/*
		 * Convert Zend_Config argument to plain string barcode name and separate config object.
		 */
	...
	public static function makeBarcode($barcode, $barcodeConfig = array()) {
		...
		/*
		 * Load the barcode class. This throws an exception if the specified class cannot be loaded.
		 */
		...
		/*
		 * Create an instance of the barcode class. Pass the config to the barcode class constructor.
		 */
