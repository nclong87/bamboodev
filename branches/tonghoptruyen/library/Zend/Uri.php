...
abstract class Zend_Uri {
	 ...
	 * If building a new URI, then $uri should contain
	...
	public static function factory($uri = 'http', $className = null) {
		...
		if ($className === null) {
			/**
			 * Create a new Zend_Uri object for the $uri.
			 * If a subclass of Zend_Uri exists for the
	 ...
	 *
	 * @return string false or false if no scheme is set.
	 */
