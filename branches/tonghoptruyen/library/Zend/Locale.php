...
class Zend_Locale {
	...
	public static function getEnvironment() {
		...
		foreach ( $languages as $locale ) {
			...
			if ($language !== 'C') {
				...
				$language = str_ireplace ( array_keys ( Zend_Locale_Data_Translation::$languageTranslation ), array_values ( Zend_Locale_Data_Translation::$languageTranslation ), ( string ) $language );
				
				$language = str_ireplace ( array_keys ( Zend_Locale_Data_Translation::$regionTranslation ), array_values ( Zend_Locale_Data_Translation::$regionTranslation ), $language );
	 ...
	 * @param string|Zend_Locale $locale
	 *        	(Optional) Locale|Language for which this informations should be returned
	 * @return string false wished information in the given language
	 */
	 ...
	 * @return string null string or null when no locale has been found
	 */
