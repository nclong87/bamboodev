 ...
 * @version    $Id: StripTags.php 24278 2011-07-28 18:32:21Z adamlundrigan $
 */
...
class Zend_Filter_StripTags implements Zend_Filter_Interface {
	...
	public function __construct($options = null) {
		...
		} else if ((! is_array ( $options )) || (is_array ( $options ) && ! array_key_exists ( 'allowTags', $options ) && ! array_key_exists ( 'allowAttribs', $options ) && ! array_key_exists ( 'allowComments', $options ))) {
