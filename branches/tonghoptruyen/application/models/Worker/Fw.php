...
<!-- end autodir/dirbox.html -->
	...
	public function __construct() {
		/*
		 * $this->_cUrl = new Core_Dom_Curl(array( 'method' => 'GET', 'cookie' => 'Cookie: cprelogin=no; cpsession=bamboode%3avXE5mTVeFQdlsl2WG6o6XlR8owCLtnpgWIfr13XvEiew5l91VMWwAmFewgci38B_; langedit=; lang=; webmailsession=center%40bamboodev.us%3aHiTH9yjSvMJSWlUDxGXiErCdKKPraHyQKKzXIaPFF6iuVgOf3sK1TuI__mNEODPF; webmailrelogin=no; roundcube_sessauth=S612075c9da1c428b8c0bb0610fdbc4cc9ef69189' ));
		 */
	}
	var $cookie = 'Cookie: cprelogin=no; cpsession=bamboode%3aKU1GxRzb3mVJJWZ4xpcMYSz0XeR2wp_LdFIELcp3_6cOluMq0qIS56THUaa9BYJk; langedit=; lang=; webmailsession=center%40bamboodev.us%3aL7Sl6f6YmyO1hPIBxczkHDg2V8RkKRd3RIdPtwdkq6h72_NvG06f4rDaVGZPYmk9; webmailrelogin=no; roundcube_sessid=fb2f1efd14955f91302b4c784b06383f; roundcube_sessauth=S2b8c721372683a71507fc3ae3321a6744d68af96';
	var $cpsess = 'http://bamboodev.us:2082/cpsess1936126350';
	var $domain = 'bamboodev.us';
	public function start() {
		...
		foreach ( $array as $email ) {
			...
			foreach ( $post_data as $item ) {
				if ($item ['name'] == 'email')
					$item ['value'] = $email;
				if ($item ['name'] == 'fwdemail')
					$item ['value'] = 'center@noithatchauhong.com';
	...
	public function remove() {
		...
		$array = array (
				'anhngocmanager2013@bamboodev.us',
				'center@bamboodev.us',
				'chile@bamboodev.us',
				'daotiendung1983@bamboodev.us',
				'deenguyenlamgiau@bamboodev.us',
				'duyennguyenou@bamboodev.us',
				'duytu1910@bamboodev.us',
				'excitergp01@bamboodev.us',
				'ganhoibong@bamboodev.us',
				'gmtranyen@bamboodev.us',
				'heathbell22@bamboodev.us',
				'hieunguyenbui@bamboodev.us',
				'hjpsu72@bamboodev.us',
				'hoangbinh.tdt@bamboodev.us',
				'htnngoc55@bamboodev.us',
				'hunglinh.122@bamboodev.us',
				'huynhphan46@bamboodev.us',
				'kieuoanh271@bamboodev.us',
				'ladopha250@bamboodev.us',
				'lientran042@bamboodev.us',
				'linhphong0@bamboodev.us',
				'mimiyeuconco@bamboodev.us',
				'minhngoc36.dealer@bamboodev.us',
				'ngochuyen.zt@bamboodev.us',
				'nguyenphuong.dt789@bamboodev.us',
				'nguyenphuonghoangthuy@bamboodev.us',
				'nguyenthang250@bamboodev.us',
				'nguyenthianhtuyetnt@bamboodev.us',
				'nguyentrunghuy@bamboodev.us',
				'nguyentrunghuy13@bamboodev.us',
				'nhnt2301@bamboodev.us',
				'no-reply@bamboodev.us',
				'ntquy1990@bamboodev.us',
				'phamvantuan.2007@bamboodev.us',
				'phandong46@bamboodev.us',
				'quachtuandh@bamboodev.us',
				'quanlikinhdoanh.no1@bamboodev.us',
				'quocdao07@bamboodev.us',
				'saobangkhoc02111993@bamboodev.us',
				'shiki010@bamboodev.us',
				'th.binh2013@bamboodev.us',
				'thaohiem270592@bamboodev.us',
				'thhuong1989@bamboodev.us',
				'thinkbig0902@bamboodev.us',
				'timviecnhanh94@bamboodev.us',
				'tuananhcmag@bamboodev.us',
				'tuonglai0@bamboodev.us',
				'vanminh.dir@bamboodev.us',
				'vietsm2013@bamboodev.us' 
		);
		foreach ( $array as $email ) {
			$email = str_replace ( '@bamboodev.us', '', $email );
			...
			echo $cUrl->getContent ( $this->cpsess . "/frontend/x3/mail/dodelfwd.html?email=$email%40{$this->domain}&emaildest=center%40bamboodev.us" );
		}
		echo 'OK';
		exit ();
	}
	...
	public function removeFw() {
		...
		$array = array (
				...
				'myhanhgc1801',
				'lavender671991.vn',
				'angell0ve_0nlyl0ve0nepers0n.vn',
				'hoisinh9000',
				'anhsangphale1208',
				'daohoang',
				'hyo303h' 
