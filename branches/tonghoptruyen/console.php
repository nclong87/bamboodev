...
defined ( 'APPLICATION_PATH' ) || define ( 'APPLICATION_PATH', realpath ( ROOT_DIR . DS . 'application' ) );

// Define application environment
defined ( 'APPLICATION_ENV' ) || define ( 'APPLICATION_ENV', (getenv ( 'APPLICATION_ENV' ) ? getenv ( 'APPLICATION_ENV' ) : 'development') );

define ( 'CONSOLE', true );
define ( 'DOMAIN', 'http://localhost/truyentranh123' );
...
require_once APPLICATION_PATH . DS . 'configs' . DS . 'define_cache.php';
...
try {
	...
	echo $error;
	/*
	 * foreach ($arrTrace as $str) echo $e->getTraceAsString();
	 */
	// print_r($arrTrace[0]);
}