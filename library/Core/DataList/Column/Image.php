...
class Core_DataList_Column_Image extends Core_DataList_Column_Abstract
{
	...
	public function renderDataCellContent($row, $data){
		...
		echo $value===null ? $this->grid->blankDisplay : Core_DataList_Html::link(Core_DataList_Html::image($this->basicUrl.DIRECTORY_SEPARATOR.$value, $this->alt, $this->imageHtmlOptions), $url, $this->linkHtmlOptions);
		echo '</td>';
	}
}
