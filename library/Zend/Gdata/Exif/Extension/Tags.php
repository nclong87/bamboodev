...
class Zend_Gdata_Exif_Extension_Tags extends Zend_Gdata_Extension {
	 ...
	 *
	 * @param Zend_Gdata_Exif_Extension_Distance $distance
	 *        	(optional) The exif:distance
	 *        	value to be set in the constructed object.
	 * @param Zend_Gdata_Exif_Extension_Exposure $exposure
	 *        	(optional) The exif:exposure
	 *        	value to be set in the constructed object.
	 * @param Zend_Gdata_Exif_Extension_Flash $flash
	 *        	(optional) The exif:flash
	 *        	value to be set in the constructed object.
	 * @param
	 *        	Zend_Gdata_Exif_Extension_FocalLength$focalLength (optional) The exif:focallength
	 *        	value to be set in the constructed object.
	 * @param Zend_Gdata_Exif_Extension_FStop $fStop
	 *        	(optional) The exif:fstop
	 *        	value to be set in the constructed object.
	 * @param Zend_Gdata_Exif_Extension_ImageUniqueId $imageUniqueId
	 *        	(optional) The exif:imageUniqueID
	 *        	value to be set in the constructed object.
	 * @param Zend_Gdata_Exif_Extension_Iso $iso
	 *        	(optional) The exif:iso
	 *        	value to be set in the constructed object.
	 * @param Zend_Gdata_Exif_Extension_Make $make
	 *        	(optional) The exif:make
	 *        	value to be set in the constructed object.
	 * @param Zend_Gdata_Exif_Extension_Model $model
	 *        	(optional) The exif:model
	 *        	value to be set in the constructed object.
	 * @param Zend_Gdata_Exif_Extension_Time $time
