...
class Zend_Gdata_Gapps_Extension_Login extends Zend_Gdata_Extension {
	 ...
	 * This is used as the user's email address
	 ...
	 * May be in cleartext or as an SHA-1
	 ...
	 * or is an SHA-1 digest of a password.
	 * If the password is cleartext,
	 ...
	 * @param boolean $changePasswordAtNextLogin
	 *        	(optional) Whether
