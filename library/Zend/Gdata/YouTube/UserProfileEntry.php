...
class Zend_Gdata_YouTube_UserProfileEntry extends Zend_Gdata_Entry {
	 ...
	 *
	 * @param Zend_Gdata_YouTube_Extension_AboutMe $aboutMe
	 *        	The 'about me'
	 *        	information.
	...
	public function setAboutMe($aboutMe = null) {
		if (($this->getMajorProtocolVersion () == null) || ($this->getMajorProtocolVersion () == 1)) {
			...
			throw new Zend_Gdata_App_VersionException ( 'The setAboutMe ' . ' method is only supported as of version 2 of the YouTube ' . 'API.' );
		} else {
			$this->_aboutMe = $aboutMe;
			return $this;
		}
	...
	public function getAboutMe() {
		if (($this->getMajorProtocolVersion () == null) || ($this->getMajorProtocolVersion () == 1)) {
			require_once 'Zend/Gdata/App/VersionException.php';
			throw new Zend_Gdata_App_VersionException ( 'The getAboutMe ' . ' method is only supported as of version 2 of the YouTube ' . 'API.' );
		} else {
	 ...
	 *
	 * @param Zend_Gdata_YouTube_Extension_FirstName $firstName
	 *        	The first name
	 * @throws Zend_Gdata_App_VersionException
	 * @return Zend_Gdata_YouTube_UserProfileEntry Provides a fluent interface
	 */
	public function setFirstName($firstName = null) {
		if (($this->getMajorProtocolVersion () == null) || ($this->getMajorProtocolVersion () == 1)) {
			require_once 'Zend/Gdata/App/VersionException.php';
			throw new Zend_Gdata_App_VersionException ( 'The setFirstName ' . ' method is only supported as of version 2 of the YouTube ' . 'API.' );
		} else {
			$this->_firstName = $firstName;
			return $this;
		}
	...
	public function getFirstName() {
		if (($this->getMajorProtocolVersion () == null) || ($this->getMajorProtocolVersion () == 1)) {
			require_once 'Zend/Gdata/App/VersionException.php';
			throw new Zend_Gdata_App_VersionException ( 'The getFirstName ' . ' method is only supported as of version 2 of the YouTube ' . 'API.' );
		} else {
	 ...
	 *
	 * @param Zend_Gdata_YouTube_Extension_LastName $lastName
	 *        	The last name
	 * @throws Zend_Gdata_App_VersionException
	 * @return Zend_Gdata_YouTube_UserProfileEntry Provides a fluent interface
	 */
	public function setLastName($lastName = null) {
		if (($this->getMajorProtocolVersion () == null) || ($this->getMajorProtocolVersion () == 1)) {
			require_once 'Zend/Gdata/App/VersionException.php';
			throw new Zend_Gdata_App_VersionException ( 'The setLastName ' . ' method is only supported as of version 2 of the YouTube ' . 'API.' );
		} else {
			$this->_lastName = $lastName;
			return $this;
		}
	...
	public function getLastName() {
		if (($this->getMajorProtocolVersion () == null) || ($this->getMajorProtocolVersion () == 1)) {
			require_once 'Zend/Gdata/App/VersionException.php';
			throw new Zend_Gdata_App_VersionException ( 'The getLastName ' . ' method is only supported as of version 2 of the YouTube ' . 'API.' );
		} else {
	...
	public function getStatistics() {
		if (($this->getMajorProtocolVersion () == null) || ($this->getMajorProtocolVersion () == 1)) {
			require_once 'Zend/Gdata/App/VersionException.php';
			throw new Zend_Gdata_App_VersionException ( 'The getStatistics ' . ' method is only supported as of version 2 of the YouTube ' . 'API.' );
		} else {
	...
	public function getThumbnail() {
		if (($this->getMajorProtocolVersion () == null) || ($this->getMajorProtocolVersion () == 1)) {
			require_once 'Zend/Gdata/App/VersionException.php';
			throw new Zend_Gdata_App_VersionException ( 'The getThumbnail ' . ' method is only supported as of version 2 of the YouTube ' . 'API.' );
		} else {
	 ...
	 * Sets the age
	 *
	 * @param Zend_Gdata_YouTube_Extension_Age $age
	 *        	The age
	 * @return Zend_Gdata_YouTube_UserProfileEntry Provides a fluent interface
	 */
	 ...
	 * Sets the username
	 *
	 * @param Zend_Gdata_YouTube_Extension_Username $username
	 *        	The username
	 * @return Zend_Gdata_YouTube_UserProfileEntry Provides a fluent interface
	 */
	 ...
	 * Sets the books
	 *
	 * @param Zend_Gdata_YouTube_Extension_Books $books
	 *        	The books
	 * @return Zend_Gdata_YouTube_UserProfileEntry Provides a fluent interface
	 */
	 ...
	 * Sets the company
	 *
	 * @param Zend_Gdata_YouTube_Extension_Company $company
	 *        	The company
	 * @return Zend_Gdata_YouTube_UserProfileEntry Provides a fluent interface
	 */
	 ...
	 * Sets the hobbies
	 *
	 * @param Zend_Gdata_YouTube_Extension_Hobbies $hobbies
	 *        	The hobbies
	 * @return Zend_Gdata_YouTube_UserProfileEntry Provides a fluent interface
	 */
	 ...
	 * Sets the hometown
	 *
	 * @param Zend_Gdata_YouTube_Extension_Hometown $hometown
	 *        	The hometown
	 * @return Zend_Gdata_YouTube_UserProfileEntry Provides a fluent interface
	 */
	 ...
	 * Sets the movies
	 *
	 * @param Zend_Gdata_YouTube_Extension_Movies $movies
	 *        	The movies
	 * @return Zend_Gdata_YouTube_UserProfileEntry Provides a fluent interface
	 */
	 ...
	 * Sets the music
	 *
	 * @param Zend_Gdata_YouTube_Extension_Music $music
	 *        	The music
	 * @return Zend_Gdata_YouTube_UserProfileEntry Provides a fluent interface
	 */
	 ...
	 * Sets the occupation
	 *
	 * @param Zend_Gdata_YouTube_Extension_Occupation $occupation
	 *        	The occupation
	 * @return Zend_Gdata_YouTube_UserProfileEntry Provides a fluent interface
	 */
	 ...
	 * Sets the school
	 *
	 * @param Zend_Gdata_YouTube_Extension_School $school
	 *        	The school
	 * @return Zend_Gdata_YouTube_UserProfileEntry Provides a fluent interface
	 */
	 ...
	 * Sets the gender
	 *
	 * @param Zend_Gdata_YouTube_Extension_Gender $gender
	 *        	The gender
	 * @return Zend_Gdata_YouTube_UserProfileEntry Provides a fluent interface
	 */
	 ...
	 *
	 * @param Zend_Gdata_YouTube_Extension_Relationship $relationship
	 *        	The relationship
	 * @return Zend_Gdata_YouTube_UserProfileEntry Provides a fluent interface
	 */
