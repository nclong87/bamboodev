...
class Zend_Reflection_File implements Reflector {
	...
	protected function _reflect() {
		...
		foreach ( $tokens as $token ) {
			/*
			 * Tokens are characters representing symbols or arrays representing strings. The keys/values in the arrays are - 0 => token id, - 1 => string, - 2 => line number Token ID's are explained here: http://www.php.net/manual/en/tokens.php.
			 */
