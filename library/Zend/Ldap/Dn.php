...
class Zend_Ldap_Dn implements ArrayAccess {
	...
	public function insert($index, array $value) {
		...
		$this->_dn = array_merge ( $first, array (
				$value 
		), $second );
		return $this;
	}
