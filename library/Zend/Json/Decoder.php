...
class Zend_Json_Decoder {
	 ...
	 *        	How objects should be decoded -- see
	 ...
	 *        	How objects should be decoded; should be
				...
				do {
					...
					if ($chr == '\\') {
						...
						switch ($chr) {
							...
							default :
								require_once 'Zend/Json/Exception.php';
								throw new Zend_Json_Exception ( "Illegal escape " . "sequence '" . $chr . "'" );
						}
					} elseif ($chr == '"') {
						break;
					} else {
