 ...
 * @version    $Id: Mcrypt.php 23775 2011-03-01 17:25:24Z ralph $
 */
...
class Zend_Filter_Encrypt_Mcrypt implements Zend_Filter_Encrypt_Interface {
	...
	protected function _openCipher() {
		$cipher = mcrypt_module_open ( $this->_encryption ['algorithm'], $this->_encryption ['algorithm_directory'], $this->_encryption ['mode'], $this->_encryption ['mode_directory'] );
