 ...
 * @version   $Id: Acceleration.php 23775 2011-03-01 17:25:24Z ralph $
 */
...
class Zend_Measure_Acceleration extends Zend_Measure_Abstract {
	...
	protected $_units = array (
			...
			'CENTIMETER_PER_SQUARE_SECOND' => array (
					'0.01',
					'cm/s²' 
			),
			'DECIGAL' => array (
			...
			'DECIMETER_PER_SQUARE_SECOND' => array (
					'0.1',
					'dm/s²' 
			),
			'DEKAMETER_PER_SQUARE_SECOND' => array (
					'10',
					'dam/s²' 
			),
			'FOOT_PER_SQUARE_SECOND' => array (
					'0.3048',
					'ft/s²' 
			),
			'G' => array (
			...
			'HECTOMETER_PER_SQUARE_SECOND' => array (
					'100',
					'h/s²' 
			),
			'INCH_PER_SQUARE_SECOND' => array (
					'0.0254',
					'in/s²' 
			),
			'KILOMETER_PER_HOUR_SECOND' => array (
					array (
							'' => '5',
							'/' => '18' 
					),
			...
			'KILOMETER_PER_SQUARE_SECOND' => array (
					'1000',
					'km/s²' 
			),
			'METER_PER_SQUARE_SECOND' => array (
					'1',
					'm/s²' 
			),
			'MILE_PER_HOUR_MINUTE' => array (
					array (
							'' => '22',
							'/' => '15',
							'*' => '0.3048',
			...
			'MILLIMETER_PER_SQUARE_SECOND' => array (
					'0.001',
					'mm/s²' 
			),
