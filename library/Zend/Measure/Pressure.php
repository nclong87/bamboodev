...
class Zend_Measure_Pressure extends Zend_Measure_Abstract {
	...
	protected $_units = array (
			...
			'CENTIMETER_MERCURY_0C' => array (
					'1333.2239',
					'cm mercury (0°C)' 
			),
			'CENTIMETER_WATER_4C' => array (
					'98.0665',
					'cm water (4°C)' 
			),
			'CENTIPASCAL' => array (
			...
			'DYNE_PER_SQUARE_CENTIMETER' => array (
					'0.1',
					'dyn/cm²' 
			),
			'EXABAR' => array (
			...
			'GRAM_FORCE_SQUARE_CENTIMETER' => array (
					'98.0665',
					'gf' 
			),
			'HECTOBAR' => array (
			...
			'KILOGRAM_FORCE_PER_SQUARE_CENTIMETER' => array (
					'98066.5',
					'kgf/cm²' 
			),
			'KILOGRAM_FORCE_PER_SQUARE_METER' => array (
					'9.80665',
					'kgf/m²' 
			),
			'KILOGRAM_FORCE_PER_SQUARE_MILLIMETER' => array (
					'9806650',
					'kgf/mm²' 
			),
			'KILONEWTON_PER_SQUARE_METER' => array (
					'1000',
					'kN/m²' 
			),
			'KILOPASCAL' => array (
			...
			'KILOPOND_PER_SQUARE_CENTIMETER' => array (
					'98066.5',
					'kp/cm²' 
			),
			'KILOPOND_PER_SQUARE_METER' => array (
					'9.80665',
					'kp/m²' 
			),
			'KILOPOND_PER_SQUARE_MILLIMETER' => array (
					'9806650',
					'kp/mm²' 
			),
			'KIP_PER_SQUARE_FOOT' => array (
					array (
							'' => '430.92233',
							'/' => '0.009' 
					),
			...
			'MEGANEWTON_PER_SQUARE_METER' => array (
					'1000000',
					'MN/m²' 
			),
			'MEGAPASCAL' => array (
			...
			'MICROMETER_MERCURY_0C' => array (
					'0.13332239',
					'µm mercury (0°C)' 
			),
			'MICROMETER_WATER_4C' => array (
					'0.00980665',
					'µm water (4°C)' 
			),
			'MICRON_MERCURY_0C' => array (
					'0.13332239',
					'µ mercury (0°C)' 
			),
			'MICROPASCAL' => array (
			...
			'MILLIMETER_MERCURY_0C' => array (
					'133.32239',
					'mm mercury (0°C)' 
			),
			'MILLIMETER_WATER_4C' => array (
					'9.80665',
					'mm water (0°C)' 
			),
			'MILLIPASCAL' => array (
			...
			'NEWTON_PER_SQUARE_METER' => array (
					'1',
					'N/m²' 
			),
			'NEWTON_PER_SQUARE_MILLIMETER' => array (
					'1000000',
					'N/mm²' 
			),
			'OUNCE_PER_SQUARE_INCH' => array (
					'430.92233',
					'oz/in²' 
			),
			'PASCAL' => array (
			...
			'POUND_PER_SQUARE_INCH' => array (
					'6894.75728',
					'lb/in²' 
			),
			'POUNDAL_PER_SQUARE_FOOT' => array (
					'1.4881639',
					'pdl/ft²' 
			),
			'STHENE_PER_SQUARE_METER' => array (
					'1000',
					'sn/m²' 
			),
			'TECHNICAL_ATMOSPHERE' => array (
					'98066.5',
					'at' 
			),
			'TERABAR' => array (
			...
			'TON_PER_SQUARE_FOOT_SHORT' => array (
					array (
							'' => '430.92233',
							'/' => '0.0045' 
					),
			...
			'TON_PER_SQUARE_INCH_SHORT' => array (
					array (
							'' => '62052.81552',
							'/' => '0.0045' 
					),
			...
			'WATER_COLUMN_CENTIMETER' => array (
					'98.0665',
					'WC (cm)' 
			),
			'WATER_COLUMN_INCH' => array (
					array (
							'' => '2989.0669',
							'/' => '12' 
					),
