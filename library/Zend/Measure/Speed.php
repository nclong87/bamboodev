 ...
 * @version   $Id: Speed.php 23775 2011-03-01 17:25:24Z ralph $
 */
...
class Zend_Measure_Speed extends Zend_Measure_Abstract {
	...
	protected $_units = array (
			...
			'CENTIMETER_PER_SECOND' => array (
					'0.01',
					'cd/s' 
			),
			'DEKAMETER_PER_DAY' => array (
					array (
							'' => '10',
							'/' => '86400' 
					),
			...
			'FURLONG_PER_SECOND' => array (
					'201.1684',
					'fur/s' 
			),
			'HECTOMETER_PER_DAY' => array (
					array (
							'' => '100',
							'/' => '86400' 
					),
			...
			'INCH_PER_SECOND' => array (
					'0.0254',
					'in/s' 
			),
			'KILOMETER_PER_DAY' => array (
					array (
							'' => '1000',
							'/' => '86400' 
					),
			...
			'MILE_PER_SECOND' => array (
					'1609.344',
					'mi/s' 
			),
			'MILLIMETER_PER_DAY' => array (
					array (
							'' => '0.001',
							'/' => '86400' 
					),
			...
			'MILLIMETER_PER_SECOND' => array (
					'0.001',
					'mm/s' 
			),
			'MILLIMETER_PER_MICROSECOND' => array (
					'1000',
					'mm/µs' 
			),
			'MILLIMETER_PER_100_MICROSECOND' => array (
					'10',
					'mm/100µs' 
			),
			'NAUTIC_MILE_PER_DAY' => array (
					array (
							'' => '1852',
							'/' => '86400' 
					),
			...
			'NAUTIC_MILE_PER_SECOND' => array (
					'1852',
					'nmi/s' 
			),
			'LIGHTSPEED_AIR' => array (
					'299702547',
					'speed of light (air)' 
			),
			'LIGHTSPEED_GLASS' => array (
					'199861638',
					'speed of light (glass)' 
			),
			'LIGHTSPEED_ICE' => array (
					'228849204',
					'speed of light (ice)' 
			),
			'LIGHTSPEED_VACUUM' => array (
					'299792458',
					'speed of light (vacuum)' 
			),
			'LIGHTSPEED_WATER' => array (
					'225407863',
					'speed of light (water)' 
			),
			'SOUNDSPEED_AIT' => array (
					'340.29',
					'speed of sound (air)' 
			),
			'SOUNDSPEED_METAL' => array (
					'5000',
					'speed of sound (metal)' 
			),
			'SOUNDSPEED_WATER' => array (
					'1500',
