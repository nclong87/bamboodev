 ...
 * @version   $Id: Lightness.php 23775 2011-03-01 17:25:24Z ralph $
 */
...
class Zend_Measure_Lightness extends Zend_Measure_Abstract {
	...
	protected $_units = array (
			...
			'CANDELA_PER_SQUARE_CENTIMETER' => array (
					'10000',
					'cd/cm²' 
			),
			'CANDELA_PER_SQUARE_FOOT' => array (
					'10.76391',
					'cd/ft²' 
			),
			'CANDELA_PER_SQUARE_INCH' => array (
					'1550.00304',
					'cd/in²' 
			),
			'CANDELA_PER_SQUARE_METER' => array (
					'1',
					'cd/m²' 
			),
			'FOOTLAMBERT' => array (
			...
			'KILOCANDELA_PER_SQUARE_CENTIMETER' => array (
					'10000000',
					'kcd/cm²' 
			),
			'KILOCANDELA_PER_SQUARE_FOOT' => array (
					'10763.91',
					'kcd/ft²' 
			),
			'KILOCANDELA_PER_SQUARE_INCH' => array (
					'1550003.04',
					'kcd/in²' 
			),
			'KILOCANDELA_PER_SQUARE_METER' => array (
					'1000',
					'kcd/m²' 
			),
			'LAMBERT' => array (
