...
class Zend_Mime_Decode {
	 ...
	 * @return array null as array('header' => array(name => value), 'body' => content), null if no parts found
	 * @throws Zend_Exception
	 */
	 ...
	 * @return string array part or all parts as array('type' => content-type, partname => value)
	 */
	 ...
	 * @return string array part or all parts as array($firstName => firstPart, partname => value)
	 * @throws Zend_Exception
	 */
