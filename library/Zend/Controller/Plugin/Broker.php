...
class Zend_Controller_Plugin_Broker extends Zend_Controller_Plugin_Abstract {
	 ...
	 * @return false Zend_Controller_Plugin_Abstract array if none found, plugin if only one found, and array of plugins if multiple plugins of same class found
	 */
