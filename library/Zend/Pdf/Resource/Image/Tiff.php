 ...
 * @version    $Id: Tiff.php 23775 2011-03-01 17:25:24Z ralph $
 */
...
class Zend_Pdf_Resource_Image_Tiff extends Zend_Pdf_Resource_Image {
	...
	public function __construct($imageFileName) {
		...
		/*
		 * Tiff files are stored as a series of Image File Directories (IFD) each direcctory has a specific number of entries each 12 bytes in length. At the end of the directories is four bytes pointing to the offset of the next IFD.
		 */
		...
		if ($this->_whiteIsZero === true) {
			$imageDictionary->Decode = new Zend_Pdf_Element_Array ( array (
