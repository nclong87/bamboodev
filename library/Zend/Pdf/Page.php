...
class Zend_Pdf_Page extends Zend_Pdf_Canvas_Abstract {
	...
	public function __construct($param1, $param2 = null, $param3 = null) {
		if (($param1 instanceof Zend_Pdf_Element_Reference || $param1 instanceof Zend_Pdf_Element_Object) && $param2 instanceof Zend_Pdf_ElementFactory_Interface && $param3 === null) {
			...
			return;
		} else if (is_string ( $param1 ) && ($param2 === null || $param2 instanceof Zend_Pdf_ElementFactory_Interface) && $param3 === null) {
			if ($param2 !== null) {
				$this->_objFactory = $param2;
			} else {
			...
			/**
			 * New page created.
			 * That's users App responsibility to track GS changes
			 */
		 ...
		 */
		} else if (is_numeric ( $param1 ) && is_numeric ( $param2 ) && ($param3 === null || $param3 instanceof Zend_Pdf_ElementFactory_Interface)) {
			if ($param3 !== null) {
	 ...
	 * @internal
	 *
	 * @return s Zend_Pdf_Resource_ContentStream
	 */
	...
	public function getHeight() {
		return $this->_dictionary->MediaBox->items [3]->value - $this->_dictionary->MediaBox->items [1]->value;
	}
	...
	public function getWidth() {
		return $this->_dictionary->MediaBox->items [2]->value - $this->_dictionary->MediaBox->items [0]->value;
	}
	...
	public function flush() {
		...
		$this->_dictionary->Contents->items [] = $this->_objFactory->newStreamObject ( $this->_contents );
	...
	public function extractFonts() {
		...
		foreach ( $fontResources->getKeys () as $fontResourceName ) {
			...
			if (! ($fontDictionary instanceof Zend_Pdf_Element_Reference || $fontDictionary instanceof Zend_Pdf_Element_Object)) {
				require_once 'Zend/Pdf/Exception.php';
