...
class Zend_Service_Amazon_Ec2_Securitygroups extends Zend_Service_Amazon_Ec2_Abstract {
	 ...
	 *        	Bottom of port range to authorize access to when operating on a CIDR IP.
	 *        	This contains the ICMP type if ICMP is being authorized.
	 * @param integer $toPort
	 *        	Top of port range to authorize access to when operating on a CIDR IP.
	 ...
	 * The permissions used to revoke must be specified
	 ...
	 * @param integer $fromPort
	 *        	Bottom of port range to revoke access to when operating on a CIDR IP.
	 *        	This contains the ICMP type if ICMP is being revoked.
	 * @param integer $toPort
	 *        	Top of port range to revoked access to when operating on a CIDR IP.
