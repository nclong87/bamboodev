...
class Zend_Service_Amazon_Ec2_Instance extends Zend_Service_Amazon_Ec2_Abstract {
	 ...
	 *
	 * @param array $options
	 *        	An array that contins the options to start an instance.
	 *        	Required Values:
	 ...
	 *
	 * @param string|array $instaceId
	 *        	Set of instances IDs of which to get the status.
	 * @param
	 ...
	 * This operation is idempotent; if you terminate
	 * an instance more than once, each call will succeed.
	 *
	 * Terminated instances will remain visible after termination (approximately one hour).
	 *
	 * @param string|array $instanceId
	 ...
	 * @return array boolean array if the product code is attached to the instance, false if it is not.
	 */
