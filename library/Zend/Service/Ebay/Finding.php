...
class Zend_Service_Ebay_Finding extends Zend_Service_Ebay_Abstract {
	...
	public function setClient($client) {
		if (! $client instanceof Zend_Rest_Client) {
			 ...
			 */
			require_once 'Zend/Service/Ebay/Finding/Exception.php';
			throw new Zend_Service_Ebay_Finding_Exception ( 'Client object must extend Zend_Rest_Client.' );
		}
		$this->_client = $client;
	 ...
	 * Can search a specific store or can search all
	...
	protected function _request($operation, array $options = null) {
		...
		$response = $client->setUri ( self::ENDPOINT_URI )->restGet ( self::ENDPOINT_PATH, $options );
