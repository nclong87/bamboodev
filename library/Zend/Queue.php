...
class Zend_Queue implements Countable {
	 ...
	 *
	 * @param string $name        	
	 * @return null mixed null if option does not exist; option value otherwise
	 */
	...
	public function setAdapter($adapter) {
		if (is_string ( $adapter )) {
			...
			$adapterName = str_replace ( ' ', '_', ucwords ( str_replace ( '_', ' ', strtolower ( $adapterNamespace . '_' . $adapter ) ) ) );
			...
			/*
			 * Create an instance of the adapter class. Pass the configuration to the adapter class constructor.
			 */
	 ...
	 *
	 * @param string $name        	
	 * @return Zend_Queue false a fluent interface
	 */
