...
class Zend_Navigation_Page_Mvc extends Zend_Navigation_Page {
	...
	public function setAction($action) {
		if (null !== $action && ! is_string ( $action )) {
			...
			throw new Zend_Navigation_Exception ( 'Invalid argument: $action must be a string or null' );
		}
	...
	public function setController($controller) {
		if (null !== $controller && ! is_string ( $controller )) {
			require_once 'Zend/Navigation/Exception.php';
			throw new Zend_Navigation_Exception ( 'Invalid argument: $controller must be a string or null' );
		}
	...
	public function setModule($module) {
		if (null !== $module && ! is_string ( $module )) {
			require_once 'Zend/Navigation/Exception.php';
			throw new Zend_Navigation_Exception ( 'Invalid argument: $module must be a string or null' );
		}
	 ...
	 *        	[optional] page params. Default is null
	...
	public function setRoute($route) {
		if (null !== $route && (! is_string ( $route ) || strlen ( $route ) < 1)) {
			require_once 'Zend/Navigation/Exception.php';
			throw new Zend_Navigation_Exception ( 'Invalid argument: $route must be a non-empty string or null' );
		}
	 ...
	 *        	whether params should be reset when
	 *        	assembling URL
	 * @return Zend_Navigation_Page_Mvc fluent interface, returns self
	 */
	 ...
	 *
	 * @param bool $resetParams
	 *        	whether href should be encoded when
	 *        	assembling URL
	 * @return Zend_Navigation_Page_Mvc fluent interface, returns self
	 */
