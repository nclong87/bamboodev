 ...
 * @version    $Id: ShortWords.php 23775 2011-03-01 17:25:24Z ralph $
 */
 ...
 * What is short word can be configured with constructor.
 *
 * @category Zend
 * @package Zend_Search_Lucene
 * @subpackage Analysis
...
class Zend_Search_Lucene_Analysis_TokenFilter_ShortWords extends Zend_Search_Lucene_Analysis_TokenFilter {
	 ...
	 *
	 * @param integer $short
	 *        	minimum allowed length of term which passes this filter (default 2)
	 */
