...
abstract class Zend_Search_Lucene_FSM {
	...
	public function process($input) {
		...
		if (isset ( $this->_inputActions [$sourceState] ) && isset ( $this->_inputActions [$sourceState] [$input] )) {
		...
		if (isset ( $this->_transitionActions [$sourceState] ) && isset ( $this->_transitionActions [$sourceState] [$targetState] )) {
